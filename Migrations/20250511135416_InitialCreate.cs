        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Delays_Stations_StationId",
                        column: x => x.StationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Delays_Trains_TrainId",
                        column: x => x.TrainId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainId = table.Column<int>(type: "int", nullable: false),
                    StationId = table.Column<int>(type: "int", nullable: false),
                    ArrivalTime = table.Column<TimeSpan>(type: "time(6)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delays_StationId",
                table: "Delays",
                column: "StationId");

            migrationBuilder.CreateIndex(
                name: "IX_Delays_TrainId",
                table: "Delays",
                column: "TrainId");
